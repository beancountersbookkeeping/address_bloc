 ...
 RSpec.describe AddressBook do
   ...
   describe "#remove_entry" do 
     it "removes an entry using the name, phone_number, and email address" do 
      book.add_entry("Kaylin Leland", "123-456-7890", "fake@fake.com")
      ...
      expect(book.entries.first.name).to eq("Kaylin Leland")
    end 
   end
   ...
   describe "#import_from_csv" do
     ...
     it "imports the 1st entry" do
       ...
       check_entry(entry_one, "Bill", "555-555-4854", "billsgit@blocmail.com")
     end  
